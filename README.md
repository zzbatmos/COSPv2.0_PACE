...
This version is COSP `v2.1.4cesm` (the COSP used by CESM2.1 and CESM2.2) with a back-port of
the HARP2 simulator: the polarimetric (cloudbow) retrieval of liquid-cloud droplet effective
radius and effective variance from HARP2 on PACE; see `src/simulator/HARP2_simulator/README.md`.
